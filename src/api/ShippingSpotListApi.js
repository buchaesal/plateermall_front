...
class ShippingSpotListApi {
    ...
    constructor() {
        this.shippingSpotList.push(new ShippingSpotModel('Y', '아무개', '010-1234-5678', '010-1234-5678', 
        '서울시 송파구 문정로 32 111-1501', '서울시 송파구 문정동 래미안아파트 111-1501'));
        this.shippingSpotList.push(new ShippingSpotModel('N', '개무아', '010-2535-4578', '010-2535-4578', 
