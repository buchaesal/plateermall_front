    ...
    <div>
        ...
        <div class="my-order-list">
            <div v-for="(cart, index) in sampleData" v-bind:key="index" class="goods-list">
                ...
                <div class="my-order-list-title;" style="background-color: GhostWhite; display: inline-block; padding: 10px 30px; width: 100%;">
...
<style scoped>
    ...
    .my-order-list-title p, .my-order-list-title a  {
        margin-top: 7px;
        color: black;
    }
